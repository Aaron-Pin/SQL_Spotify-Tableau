-- First I combine my streaminghistory0 and streaminghistory1 table together using UNION ALL, I then do the same for streamhistory2 and streaminghistory3 on a separate
-- tab. Then, for all my duplicate tracks, I add their msPlayed by their trackName.
...
-- stream it, making your data have many duplicates.
